...
export class ApiDocsView {
  ...
  render() {
    ...
    const endpoints = [
      ...
      { method: 'GET', path: '/api/v1/admin/operators/{id}/agents', tag: 'Operators', desc: 'List AI models enabled for carrier' },
      { method: 'POST', path: '/api/v1/admin/operators/{id}/agents', tag: 'Operators', desc: 'Assign AI model to carrier portal' },
      { method: 'DELETE', path: '/api/v1/admin/operators/{id}/agents/{agentId}', tag: 'Operators', desc: 'Unassign AI model from carrier' },
      ...
      { method: 'GET', path: '/api/v1/admin/providers/{operatorId}/{type}/config', tag: 'Providers', desc: 'Retrieve encrypted gateway config' },
      { method: 'POST', path: '/api/v1/admin/providers/{operatorId}/{type}/config', tag: 'Providers', desc: 'Store encrypted gateway config' },
      { method: 'GET', path: '/api/v1/admin/ai/catalog', tag: 'AI Catalog', desc: 'Global AI model catalog list' },
      { method: 'POST', path: '/api/v1/admin/ai/catalog', tag: 'AI Catalog', desc: 'Publish new AI assistant to catalog' },
      { method: 'PUT', path: '/api/v1/admin/ai/catalog/{id}', tag: 'AI Catalog', desc: 'Update AI persona & hyper-parameters' },
      { method: 'DELETE', path: '/api/v1/admin/ai/catalog/{id}', tag: 'AI Catalog', desc: 'Delete AI assistant from catalog' },
